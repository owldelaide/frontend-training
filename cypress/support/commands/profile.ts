...
export const updateProfile = ((username = 'admin', password = '123') => {
    cy.getByTestId('EditableProfileCardHeader.EditButton').click();
    cy.getByTestId('ProfileCard.firstname').clear().type('newFn');
    cy.getByTestId('ProfileCard.lastname').clear().type('newLn');
